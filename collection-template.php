...
<head>
  ...
  <link rel="stylesheet" href="pdp.css"><link rel="stylesheet" href="header.css"><link rel="stylesheet" href="collection.css"><link rel="stylesheet" href="collection-spotlight.css"><link rel="stylesheet" href="collections-hub.css">
  <?php if ($collectionKey === 'men'): ?><link rel="stylesheet" href="mens-collection.css"><?php endif; ?>
</head>
<body><?php $pageType = 'collection'; require __DIR__ . '/header.php'; ?>
<main class="collection-page collection-page--<?= htmlspecialchars($collectionKey) ?>">
  ...
  <section class="collection-portal" style="--portal-background:url('<?= htmlspecialchars($config['hero']) ?>')"><span>Official Retail Partner</span><h2>Continue your<br><em>acquisition</em></h2><p>Purchasing is completed securely through our official retail portal.</p><a href="https://www.indiekonnect.com/" target="_blank" rel="noopener noreferrer">Visit IndieKonnect&nbsp; ↗</a></section>
