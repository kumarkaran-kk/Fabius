...
$configs = [
  'men' => ['title' => "Men's Watches", 'display' => "Men's", 'intro' => 'Architectural mechanics, decisive proportions and enduring materials.', 'hero' => 'assets/new-images/optimized/hero-resolute-black.webp', 'label' => 'Resolute', 'word' => 'presence', 'statement' => 'Exposed mechanics meet confident silhouettes in watches created to move with purpose.'],
  'women' => ['title' => "Women's Watches", 'display' => "Women's", 'intro' => 'Radiant materials, refined proportions and effortless contemporary elegance.', 'hero' => 'assets/new-images/optimized/products/promo-womens-watch.webp', 'label' => 'Lumina', 'word' => 'radiance', 'statement' => 'Mother-of-pearl dials and considered details illuminate every moment without excess.'],
  ...
  'quartz' => ['title' => 'Quartz Watches', 'display' => 'Quartz', 'intro' => 'Dependable precision expressed through luminous materials and composed proportions.', 'hero' => 'assets/new-images/optimized/products/promo-womens-watch.webp', 'label' => 'Precision', 'word' => 'clarity', 'statement' => 'Quartz Slim movements bring effortless accuracy to refined everyday timekeeping.'],
  'limited' => ['title' => 'Limited Editions', 'display' => 'Limited', 'intro' => 'Rare expressions reserved for defining chapters in the story of FABIUS.', 'hero' => 'assets/new-images/optimized/products/manifesto-watch-background.webp', 'label' => 'Exceptional', 'word' => 'rarity', 'statement' => 'Limited editions will be introduced only when a timepiece has a singular story worth preserving.'],
];
