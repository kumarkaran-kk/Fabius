...
<main class="collections-hub">
  ...
  <section class="collection-directory">
    <header class="pdp-reveal"><span>Explore</span><h2>Find Your<br><em>Expression</em></h2></header>
    <div class="collection-directory-grid">
      ...
      foreach ($cards as $card): ?>
        <a class="directory-card pdp-reveal" href="<?= $card[2] ?>"><img src="<?= $card[3] ?>" alt=""><div><span>Collection</span><h2><?= htmlspecialchars($card[0]) ?></h2><p><?= htmlspecialchars($card[1]) ?></p><b>Explore&nbsp; →</b></div></a>
      <?php endforeach; ?>
    </div>
  </section>
</main>
